...
> [**v1.6.2**](https://github.com/codeworksdev/mochi-1.0/releases/latest) &nbsp;➜&nbsp;  [**v2.2**](https://github.com/codeworksdev/mochi-2.0/releases/latest)
...
In addition to Sass, Mochi 2.0 makes heavy use of [Less.js](http://lesscss.org/) to allow you to rapidly construct your CSS stylesheets within the many [predefined media queries](https://github.com/codeworksdev/mochi-2.0?tab=readme-ov-file#predefined-media-queries) supported by our [standard distribution package](https://github.com/codeworksdev/mochi-2.0/tree/main/dist).
...
| [Methods](https://github.com/codeworksdev/mochi-2.0?tab=readme-ov-file#methods)                          | [Hooks](https://github.com/codeworksdev/mochi-2.0?tab=readme-ov-file#hooks)                             | [Options](https://github.com/codeworksdev/mochi-2.0?tab=readme-ov-file#options)                                                 | [Properties](https://github.com/codeworksdev/mochi-2.0?tab=readme-ov-file#properties) |
|----------------------------------------------|---------------------------------------------|---------------------------------------------------------------------|---------------------------|
| [do](https://github.com/codeworksdev/mochi-2.0?tab=readme-ov-file#mdo)                                   | [mochi_before](https://github.com/codeworksdev/mochi-2.0?tab=readme-ov-file#mochi_before)               | [CLICK_NAME](https://github.com/codeworksdev/mochi-2.0?tab=readme-ov-file#click_name)                                           | __body                    |
| [extend](https://github.com/codeworksdev/mochi-2.0?tab=readme-ov-file#mextend)                           | [mochi_init](https://github.com/codeworksdev/mochi-2.0?tab=readme-ov-file#mochi_init)                   | [DEBUG_MODE](https://github.com/codeworksdev/mochi-2.0?tab=readme-ov-file#debug_mode)                                           | __container               |
| [getDefaultOption](https://github.com/codeworksdev/mochi-2.0?tab=readme-ov-file#mgetdefaultoption)       | [mochi_load](https://github.com/codeworksdev/mochi-2.0?tab=readme-ov-file#mochi_load)                   | [ENABLE_SERVICE_WORKER](https://github.com/codeworksdev/mochi-2.0?tab=readme-ov-file#enable_service_worker)                     | __content                 |
| [getOnClickName](https://github.com/codeworksdev/mochi-2.0?tab=readme-ov-file#mgetonclickname)           | [mochi_load_page](https://github.com/codeworksdev/mochi-2.0?tab=readme-ov-file#mochi_load_page)         | [LAZY_LOAD_PLUGINS](https://github.com/codeworksdev/mochi-2.0?tab=readme-ov-file#lazy_load_plugins)                             | __head                    |
| [getOption](https://github.com/codeworksdev/mochi-2.0?tab=readme-ov-file#mgetoption)                     | [mochi_load_page{N}](https://github.com/codeworksdev/mochi-2.0?tab=readme-ov-file#mochi_load_pagen)     | [SW_UPDATE_NOTIFICATIONS](https://github.com/codeworksdev/mochi-2.0?tab=readme-ov-file#sw_update_notifications)                 | __href                    |
| [getPage](https://github.com/codeworksdev/mochi-2.0?tab=readme-ov-file#mgetpage)                         | [mochi_load_view](https://github.com/codeworksdev/mochi-2.0?tab=readme-ov-file#mochi_load_view)         | [SW_UPDATE_NOTIFICATIONS_OPTIONS](https://github.com/codeworksdev/mochi-2.0?tab=readme-ov-file#sw_update_notifications_options) | __html                    |
| [getState](https://github.com/codeworksdev/mochi-2.0?tab=readme-ov-file#mgetstate)                       | [mochi_load_view{N}](https://github.com/codeworksdev/mochi-2.0?tab=readme-ov-file#mochi_load_viewn)     | [SW_VERBOSE_SYNCING](https://github.com/codeworksdev/mochi-2.0?tab=readme-ov-file#sw_verbose_syncing)                           | __observer                |
...
>
>  _**Note:** This method is especially useful for [plugin development](https://github.com/codeworksdev/mochi-2.0?tab=readme-ov-file#plugins)._

> ## $m.getDefaultOption()
>
> _mixed_ **$m.getDefaultOption(** _string_ **name** **)**
>
> Shorthand for [`$m.getOption(name, true)`](https://github.com/codeworksdev/mochi-2.0?tab=readme-ov-file#mgetoption).

> ## $m.getOption()
>
> _mixed_ **$m.getOption(** _string_ **name**[, _bool_ **default**] **)**
>
> Returns the value of the requested [option](https://github.com/codeworksdev/mochi-2.0?tab=readme-ov-file#options) by `name` (case-sensitive). If `default` is `true`, returns the default value of the option instead, as defined by the framework. If the requested option is a [`Function`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Function) type, gets the return value of that function, `undefined` otherwise. If the return value is a [`simple object`](https://github.com/codeworksdev/mochi-2.0?tab=readme-ov-file#missimpleobj) type, returns a [deep copy](https://scotch.io/bar-talk/copying-objects-in-javascript#toc-deep-copying-objects) of that object.

> ## $m.getOnClickName()
>
> _string_ **$m.getOnClickName()**
>
> Returns the current value of the [`CLICK_NAME`](https://github.com/codeworksdev/mochi-2.0?tab=readme-ov-file#click_name) option. Additionally, if [`CLICK_NAME`](https://github.com/codeworksdev/mochi-2.0?tab=readme-ov-file#click_name) is currently set to `"auto"`, returns the [`touchstart`](https://developer.mozilla.org/en-US/docs/Web/Events/touchstart) event name for [touch-enabled](https://developer.mozilla.org/en-US/docs/Web/API/Touch_events) devices, and [`click`](https://developer.mozilla.org/en-US/docs/Web/Events/click) for all other device types.

> ## $m.getPage()
>
> _number_ **$m.getPage(** [_number_ **padding**] **)**
>
> Shorthand for [`$m.getState('page', padding)`](https://github.com/codeworksdev/mochi-2.0?tab=readme-ov-file#mgetstate). Returns the value of the `data-page` attribute in `<html>` for the active HTML document. Assumes `0` (zero) if `data-page` is undefined or not numeric. If `padding` is given, zero-pads the returned number by that amount. By default, `0` (zero) is returned with the given `padding`.
...
>
> Calls a series of [hooks](https://github.com/codeworksdev/mochi-2.0?tab=readme-ov-file#hooks) based on either the `"page"` or `"view"` string, and `number` given. For example, `$m.load("page", 1.5)` implies the `data-page` attribute in `<html>` for the active HTML document must be changed to `1.5`, but only if `data-page` isn't already set to `1.5`. If a `meta` [object](https://github.com/codeworksdev/mochi-2.0?tab=readme-ov-file#missimpleobj) is given, passes that object as the first parameter for each called hook, with `this` assigned as a reference to `$m` ([persistent Mochi 2.0 instance](https://github.com/codeworksdev/mochi-2.0?tab=readme-ov-file#persistent-mochi-instance)).
>
> **FOR EXAMPLE**
...
> ```
> _**Note:** Each hook receives a default meta object of key/value pairs as the first parameter, with `this` assigned as a reference to `$m` ([persistent Mochi 2.0 instance](https://github.com/codeworksdev/mochi-2.0?tab=readme-ov-file#persistent-mochi-instance)). If the optional `meta` object is given as the 3rd parameter, merges it with this default object, ensuring each property listed below is not overridden. See below for a list of mandatory properties in the default meta object._
>
> **DEFAULT META OBJECT**
>
> | property       | type   | description                                                                               |
> |----------------|--------|-------------------------------------------------------------------------------------------|
> | caller         | string | Name of function or constructor that called this method (e.g., "[loadPage](https://github.com/codeworksdev/mochi-2.0?tab=readme-ov-file#mloadpage)"). |
...
>  2. Each hook receives a meta object as its first parameter. See [`$m.load()`](https://github.com/codeworksdev/mochi-2.0?tab=readme-ov-file#mload) for details.
...
>
> Shorthand for [`$m.setState("view", number)`](https://github.com/codeworksdev/mochi-2.0?tab=readme-ov-file#msetstate).

> ## $m.unload()
>
> _Mochi_ **$m.unload(** _string_ **page|view**, _number_ **number**[, _object_ **meta**] **)**
>
> Similar to [`$m.load()`](https://github.com/codeworksdev/mochi-2.0?tab=readme-ov-file#mload), but calls unloading hooks instead.
>
> **FOR EXAMPLE**
...
_**Note:** Hook are completely optional within your project and, if defined, are called with `this` assigned as a reference to `$m` ([persistent Mochi 2.0 instance](https://github.com/codeworksdev/mochi-2.0?tab=readme-ov-file#persistent-mochi-instance)). Additionally, some of these hooks receive a [meta object](https://github.com/codeworksdev/mochi-2.0?tab=readme-ov-file#mload) as the first (and only) parameter. This object contains information regarding the call. More information [here](https://github.com/codeworksdev/mochi-2.0?tab=readme-ov-file#mload)._

> ## mochi_before()
>
> _void_ **mochi_before()**
>
> If defined, executes during Mochi 2.0 instance initialization (e.g., before all other initialization methods are called and [`$m`](https://github.com/codeworksdev/mochi-2.0?tab=readme-ov-file#persistent-mochi-instance) is defined), but after all default [`options`](https://github.com/codeworksdev/mochi-2.0?tab=readme-ov-file#options) are set. Useful if you'd like to define some options or run statements before anything else fires up.

> ## mochi_init()
>
> _void_ **mochi_init()**
>
> If defined, executes during Mochi 2.0 instance initialization, but only after all other initialization methods are called. Useful if you'd like to run statements before all other hooks are called, and before some components are loaded (e.g., before the built-in [caching system](https://github.com/codeworksdev/mochi-2.0?tab=readme-ov-file#caching-system) kicks in).

> ## mochi_load()
>
> _void_ **mochi_load(** [_object_ **meta**] **)**
>
> If defined, executes as soon as [`$m`](https://github.com/codeworksdev/mochi-2.0?tab=readme-ov-file#persistent-mochi-instance) is set, as well as whenever the `data-page` or `data-view` attributes in `<html>` for the active HTML document are set. (e.g., whenever [`$m.setState()`](https://github.com/codeworksdev/mochi-2.0?tab=readme-ov-file#msetstate) is called). This hook always precedes the [`mochi_load_page()`](https://github.com/codeworksdev/mochi-2.0?tab=readme-ov-file#mochi_load_page) and [`mochi_load_view()`](https://github.com/codeworksdev/mochi-2.0?tab=readme-ov-file#mochi_load_view) hooks. Additionally, [`meta`](https://github.com/codeworksdev/mochi-2.0?tab=readme-ov-file#mload) is defined only when the `data-page` or `data-view` attributes in `<html>` for the active HTML document are changed from a previous (or initial) value.

> ## mochi_load_page()
>
> _void_ **mochi_load_page(** [_object_ **meta**] **)**
>
> If defined, executes as soon as [`$m`](https://github.com/codeworksdev/mochi-2.0?tab=readme-ov-file#persistent-mochi-instance) is set, as well as whenever the `data-page` attribute in `<html>` for the active HTML document is set (e.g., when [`$m.setState()`](https://github.com/codeworksdev/mochi-2.0?tab=readme-ov-file#msetstate) is called). This hook always precedes the [`mochi_load_page{N}()`](https://github.com/codeworksdev/mochi-2.0?tab=readme-ov-file#mochi_load_pagen) hook, where **`{N}`** is the number that was assigned to `data-page`. Additionally, [`meta`](https://github.com/codeworksdev/mochi-2.0?tab=readme-ov-file#mload) is defined only when the `data-page` attribute in `<html>` for the active HTML document is changed from a previous (or initial) value.

> ## mochi_load_page{N}()
>
> _void_ **mochi_load_page{N}(** [_object_ **meta**] **)**
>
> If defined, executes whenever the `data-page` attribute in `<html>` for the active HTML document is set to **`{N}`**, where **`{N}`** is to be replaced with the appropriate number that was assigned to `data-page`. For example, the `mochi_load_page1_5()` hook is called if the current value of the `data-page` attribute in `<html>` for the active HTML document is changed to `1.5`, but only if the current value isn't already set to `1.5`. This hook is always called immediately after the [`mochi_page_load()`](https://github.com/codeworksdev/mochi-2.0?tab=readme-ov-file#mochi_page_load) hook is called. Additionally, [`meta`](https://github.com/codeworksdev/mochi-2.0?tab=readme-ov-file#mload) is defined only when the `data-page` attribute in `<html>` for the active HTML document is changed from a previous (or initial) value.

> ## mochi_load_view()
>
> _void_ **mochi_load_view(** [_object_ **meta**] **)**
>
> If defined, executes as soon as [`$m`](https://github.com/codeworksdev/mochi-2.0?tab=readme-ov-file#persistent-mochi-instance) is set, as well as whenever the `data-view` attribute in `<html>` for the active HTML document is set (e.g., when [`$m.setState()`](https://github.com/codeworksdev/mochi-2.0?tab=readme-ov-file#msetstate) is called). This hook always precedes the [`mochi_load_view{N}()`](https://github.com/codeworksdev/mochi-2.0?tab=readme-ov-file#mochi_load_viewn) hook, where **`{N}`** is the number that was assigned to `data-view`. Additionally, [`meta`](https://github.com/codeworksdev/mochi-2.0?tab=readme-ov-file#mload) is defined only when the `data-view` attribute in `<html>` for the active HTML document is changed from a previous (or initial) value.

> ## mochi_load_view{N}()
>
> _void_ **mochi_load_view{N}(** [_object_ **meta**] **)**
>
> If defined, executes whenever the `data-view` attribute in `<html>` for the active HTML document is set to **`{N}`**, where **`{N}`** is to be replaced with the appropriate number that was assigned to `data-view`. For example, the `mochi_load_view1_5()` hook is called if the current value of the `data-view` attribute in `<html>` for the active HTML document is changed to `1.5`, but only if the current value isn't already set to `1.5`. This hook is always called immediately after the [`mochi_view_load()`](https://github.com/codeworksdev/mochi-2.0?tab=readme-ov-file#mochi_page_load) hook is called. Additionally, [`meta`](https://github.com/codeworksdev/mochi-2.0?tab=readme-ov-file#mload) is defined only when the `data-view` attribute in `<html>` for the active HTML document is changed from a previous (or initial) value.

> ## mochi_unload()
>
> _void_ **mochi_unload(** _object_ **meta** **)**
>
> If defined, executes whenever the `data-page` or `data-view` attributes in `<html>` for the active HTML document are changed (e.g., when `data-page` changes from `1.5` to `2`). This hook always precedes the [`mochi_unload_page()`](https://github.com/codeworksdev/mochi-2.0?tab=readme-ov-file#mochi_unload_page) and [`mochi_unload_view()`](https://github.com/codeworksdev/mochi-2.0?tab=readme-ov-file#mochi_unload_view) hooks. Additionally, [`meta`](https://github.com/codeworksdev/mochi-2.0?tab=readme-ov-file#mload) is always defined, and includes [details](https://github.com/codeworksdev/mochi-2.0?tab=readme-ov-file#mload) regarding the call.

> ## mochi_unload_page()
>
> _void_ **mochi_unload_page(** _object_ **meta** **)**
>
> If defined, executes whenever the `data-page` attribute in `<html>` for the active HTML document is changed (e.g., when `data-page` changes from `1.5` to `2`). This hook always precedes the [`mochi_unload_page{N}()`](https://github.com/codeworksdev/mochi-2.0?tab=readme-ov-file#mochi_unload_pagen) hook, where **`{N}`** is the number that was changed in `data-page`. Additionally, [`meta`](https://github.com/codeworksdev/mochi-2.0?tab=readme-ov-file#mload) is always defined, and includes [details](https://github.com/codeworksdev/mochi-2.0?tab=readme-ov-file#mload) regarding the call.

> ## mochi_unload_page{N}()
>
> _void_ **mochi_unload_page{N}(** _object_ **meta** **)**
>
> If defined, executes whenever the `data-page` attribute in `<html>` for the active HTML document is changed from **`{N}`** to a different number, where **`{N}`** is the number that was changed in `data-page`. For example, the `mochi_unload_page2()` hook is called if the value of the `data-page` attribute in `<html>` for the active HTML document was changed from `2` to a different number. This hook is always called immediately after the [`mochi_page_unload()`](https://github.com/codeworksdev/mochi-2.0?tab=readme-ov-file#mochi_page_unload) hook is called. No action is taken if the number did not change. Additionally, [`meta`](https://github.com/codeworksdev/mochi-2.0?tab=readme-ov-file#mload) is always defined, and includes [details](https://github.com/codeworksdev/mochi-2.0?tab=readme-ov-file#mload) regarding the call.

> ## mochi_unload_view()
>
> _void_ **mochi_unload_view(** _object_ **meta** **)**
>
> If defined, executes whenever the `data-view` attribute in `<html>` for the active HTML document is changed (e.g., when `data-view` changes from `1.5` to `2`). This hook always precedes the [`mochi_unload_view{N}()`](https://github.com/codeworksdev/mochi-2.0?tab=readme-ov-file#mochi_unload_viewn) hook, where **`{N}`** is the number that was changed in `data-view`. Additionally, [`meta`](https://github.com/codeworksdev/mochi-2.0?tab=readme-ov-file#mload) is always defined, and includes [details](https://github.com/codeworksdev/mochi-2.0?tab=readme-ov-file#mload) regarding the call.

> ## mochi_unload_view{N}()
>
> _void_ **mochi_unload_view{N}(** _object_ **meta** **)**
>
> If defined, executes whenever the `data-view` attribute in `<html>` for the active HTML document is changed from **`{N}`** to a different number, where **`{N}`** is the number that was changed in `data-view`. For example, the `mochi_unload_view2()` hook is called if the value of the `data-view` attribute in `<html>` for the active HTML document was changed from `2` to a different number. This hook is always called immediately after the [`mochi_view_unload()`](https://github.com/codeworksdev/mochi-2.0?tab=readme-ov-file#mochi_view_unload) hook is called. No action is taken if the number did not change. Additionally, [`meta`](https://github.com/codeworksdev/mochi-2.0?tab=readme-ov-file#mload) is always defined, and includes [details](https://github.com/codeworksdev/mochi-2.0?tab=readme-ov-file#mload) regarding the call.

> ## mochi_last()
>
> _void_ **mochi_last()**
>
> If defined, executes after Mochi 2.0 instance initialization (e.g., after all other initialization methods are called and [`$m`](https://github.com/codeworksdev/mochi-2.0?tab=readme-ov-file#persistent-mochi-instance) is defined), and all other hooks are called. This hook is essentially the opposite of [`mochi_before()`](https://github.com/codeworksdev/mochi-2.0?tab=readme-ov-file#mochi_before), and only executes once for the life of the active HTML document.

> ## mochi_onchange()
>
> _void_ **mochi_onchange(** _object_ **meta** **)**
>
> If defined, executes whenever the values of the `data-page` or `data-view` attributes in `<html>` for the active HTML document are change. This is especially useful when you need to execute some statements whenever a valid `data-page` or `data-view` attribute value change is detected, but only after all relevant hooks are called. With that said, [`meta`](https://github.com/codeworksdev/mochi-2.0?tab=readme-ov-file#mload) is always defined, and includes [details](https://github.com/codeworksdev/mochi-2.0?tab=readme-ov-file#mload) regarding the call.
...
| Option                                                                | Type     | Default                                                      |
|-----------------------------------------------------------------------|----------|--------------------------------------------------------------|
| [`CLICK_NAME`](https://github.com/codeworksdev/mochi-2.0?tab=readme-ov-file#click_name)                                           | `string` | `auto`                                                       |
| [`DEBUG_MODE`](https://github.com/codeworksdev/mochi-2.0?tab=readme-ov-file#debug_mode)                                           | `bool`   | `false`                                                      |
...
> ## CLICK_NAME
>
> Determines the name of the JavaScript [event](https://developer.mozilla.org/en-US/docs/Learn/JavaScript/Building_blocks/Events) to be used by the [`$m.onClick()`](https://github.com/codeworksdev/mochi-2.0?tab=readme-ov-file#monclick) method. If set to `"auto"`, the event name will be determined automatically depending on the active host device type. For example, [`touchstart`](https://developer.mozilla.org/en-US/docs/Web/Events/touchstart) would be used for touch-enabled devices, while [`click`](https://developer.mozilla.org/en-US/docs/Web/Events/click) would be used for all other device types.
...
>
> If set to `true`, activates the built-in [Service Worker](https://developer.mozilla.org/en-US/docs/Web/API/Service_Worker_API/Using_Service_Workers). More information [here](https://github.com/codeworksdev/mochi-2.0?tab=readme-ov-file#caching-system).

> ## LAZY_LOAD_PLUGINS
>
> Use this flag to allow Mochi 2.0 to "lazy load" a series of [plugins](https://github.com/codeworksdev/mochi-2.0?tab=readme-ov-file#plugins), but only after the active HTML document is fully rendered, and other scripts have finished executing. This is especially useful if/when your application meets one or more of the following criteria:
>
...
>
> If set to `true`, allows Mochi 2.0 to produce an HTML-formatted [notification widget](https://github.com/codeworksdev/mochi-2.0?tab=readme-ov-file#mwidgetonupdateready) on screen, suggesting to the user that an app refresh/reload is necessary (e.g., when the built-in [Service Worker](https://github.com/codeworksdev/mochi-2.0?tab=readme-ov-file#caching-system) downloads updated assets from the network). More information [here](https://github.com/codeworksdev/mochi-2.0?tab=readme-ov-file#mwidgetonupdateready).
...
> ## SW_VERBOSE_SYNCING
>
> If set to `true` (default), allows Mochi 2.0 to produce an HTML-formatted [alert widget](https://github.com/codeworksdev/mochi-2.0?tab=readme-ov-file#mwidgetondownloading), indicating to the user that an operation is in progress and the app is busy (e.g., downloading network resources). More information [here](https://github.com/codeworksdev/mochi-2.0?tab=readme-ov-file#mwidgetondownloading).
